...
import { Client, getClientByPhoneNumber } from '@kim-pro-git/carrot-reboot-backend/lib/firestore';
 ...
 */
export async function getLocallyLoggedInClient(): Promise<Client | null> {
...
export async function loginLocally(token: string): Promise<Client> {
